...
bot = Client("My First Project",api_id=24541704,
             api_hash="7b1b63a5c5a2e53233a0e78727c068d3",
             bot_token="6483695475:AAEUrXwwE-kMRhTZAL48o60u3j4nbbZsL3g")

@bot.on_message(filters.command('start'))
def start1(bot, message):
  bot.send_message(message.chat.id,"Hey! You can Search Anime & Manga Using this bot")
